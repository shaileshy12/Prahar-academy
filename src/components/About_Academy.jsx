...
const About_Academy = () => {
  ...
  return (
    <div key={i18n.language} className="w-full py-16 md:py-24 bg-gradient-to-b from-slate-50/50 to-white/50">
        ...
        <div className="grid md:grid-cols-2 gap-8 lg:gap-16 md:items-center">
          ...
          <div className="order-2 md:order-1 space-y-6 max-w-none md:max-w-lg lg:max-w-xl">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 leading-tight">
              {t("home.aboutAcademy.heading")}
            </h2>
            <div className="text-base md:text-lg lg:text-xl text-gray-700 leading-relaxed text-justify md:text-justify">
              <p className="text-justify mb-4">
                {t("home.aboutAcademy.p1")}
              </p>
              <p className="text-justify">
                {t("home.aboutAcademy.p2")}
              </p>
            </div>
          </div>

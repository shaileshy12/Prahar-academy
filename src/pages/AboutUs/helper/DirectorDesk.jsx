...
const DirectorDesk = () => {
  return (
    <div className="min-h-screen bg-white text-gray-900 flex flex-col">
      ...
      {/* ── Director journey — WHITE BACKGROUND ── */}
          ...
          <div className="grid lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] gap-10 lg:gap-12 items-start">
            ...
            <div className="text-left">
              <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900">
                Director's <span className="text-amber-600">journey.</span>
              </h2>
              ...
              <div className="mt-4 max-w-3xl mx-auto text-sm sm:text-base text-gray-700 leading-relaxed text-justify">
                <p className="mb-3">
                  ...
                  deep respect for those who dedicate their lives to serving the nation. 
                  <div>– Rakesh Garase Sir</div>
                </p>
                <p className="mb-3">
            ...
            <div className="space-y-5">
              <div className="rounded-3xl border border-gray-200 bg-gray-50 p-5 sm:p-6 shadow-sm text-left">
                ...
                <div className="mt-4">
                  <p className="text-sm font-semibold text-gray-900">Rakesh Garase</p>
